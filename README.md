...
RUNBRO 화면은 `assets/runbro.css`, `assets/runbro.js`, `assets/runbro-config.js`를 사용합니다. 개인 목표와 러닝 기록은 브라우저 저장소가 아닌 별도 AWS API에 저장하며, Strava·Garmin·Gemini 연동 방법은 `backend/RUNBRO_SETUP.md`를 참고하세요.
