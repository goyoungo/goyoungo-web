...
RUNBRO 화면은 `assets/runbro.css`, `assets/runbro.js`, `assets/runbro-config.js`를 사용합니다. 개인 목표와 Garmin 러닝 기록은 브라우저 저장소가 아닌 별도 AWS API에 저장합니다. 최근 러닝 자동 분류, 4·8·12주 거리·VDOT·심박존 추세, 근거형 다음 훈련 제안과 월간 훈련 달력을 제공하며, Garmin 및 Gemini 3.6 Flash·ChatGPT 앱 교차검증 설정은 `backend/RUNBRO_SETUP.md`를 참고하세요.
